...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnRecord_onClick(View view) {
        ...
        if (!isRec) {
            ...
            rec.setOutputFile(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/sound.mp3");
            try {
                rec.prepare();
    ...
    //vbeuivebruvrivbrdwhvredvbknvuebioewnibjnwebbnewivwurvvwburvwuewvuebvjkwbvewbvjwbvew
    @Override
